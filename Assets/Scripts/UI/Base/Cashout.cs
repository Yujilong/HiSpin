...
namespace HiSpin
{
    public class Cashout : BaseUI
    {
        ...
        public GameObject top_right_paypayGo3;
        ...
        protected override void Awake()
        {
            ...
            if (Language_M.isJapanese)
            {
                ...
                top_right_paypayGo3.SetActive(true);
                top_right_paypayGo4.SetActive(true);
                num_front_iconImage.sprite = Sprites.GetSprite(SpriteAtlas_Name.Cashout, "paypay");
        ...
        public override void SetContent()
        {
            ...
            cash_numText.text = string.Format(dollar, (Save.data.allData.user_panel.user_doller_live / CashToDollerRadio).GetCashShowString());
            cash_cashout_left_buttonText.text = string.Format(dollar, Language_M.isJapanese ? " 20000" : " 200");
            cash_cashout_mid_buttonText.text = string.Format(dollar, Language_M.isJapanese ? " 30000" : " 300");
            cash_cashout_right_buttonText.text = string.Format(dollar, Language_M.isJapanese ? " 50000" : " 500");
