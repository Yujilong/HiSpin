...
namespace UI
{
    ...
    {
        const string UI_Prefab_Path_Pre = "MergeBall/Prefabs/UI/";
        static readonly Dictionary<int, string> UI_Type_Path_Dic = new Dictionary<int, string>()
        {
            ...
            { UI_Panel.UI_PopPanel.OpenGoldBallPanel , "Pop GetGoldBall Panel" },
    ...
    public struct UI_Panel
    {
        ...
        public struct UI_PopPanel
        {
            ...
            public const int OpenGoldBallPanel = 13;
            public const int PopPanelNum = 13;
        }
    }
}
