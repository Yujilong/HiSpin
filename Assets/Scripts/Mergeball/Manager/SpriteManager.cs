...
public class SpriteManager
{
    ...
    {
        { SpriteAtlas_Name.Ball,"MergeBall/SpriteAtlas/Ball" },
        { SpriteAtlas_Name.RewardNoCash,"MergeBall/SpriteAtlas/RewardNoCash"},
        { SpriteAtlas_Name.Menu,"MergeBall/SpriteAtlas/Menu"},
