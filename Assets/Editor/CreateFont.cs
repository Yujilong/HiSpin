...
public class FontWizard : ScriptableWizard
{
    ...
    //private void OnGUI()
    //{
    //    chartext = GUILayout.TextField(chartext, GUILayout.Height(50));
    //    GUILayout.Label((Encoding.ASCII.GetBytes(chartext)[0]).ToString());
    //}
}
